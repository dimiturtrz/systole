...
def test_axis_dict_has_published_shape():
    ...
    out = Results.axis_dict(150, _dists(), _dice(), _stats())
    assert out["n"] == 150
...
def test_axis_dict_rounds_per_class_dice_3dp():
    ...
    out = Results.axis_dict(2, _dists(), _dice(vals=(0.86412, 0.8, 0.9)), _stats())
...
def test_axis_dict_mean_dice_over_classes():
    ...
    out = Results.axis_dict(2, _dists(), _dice(vals=(0.9, 0.8, 0.7)), _stats())
...
def test_axis_dict_ef_fields_rounded_1dp():
    ...
    out = Results.axis_dict(2, _dists(), _dice(), _stats(mae=4.27, bias=-3.14, loa=(-12.05, 5.83)))
...
def test_axis_dict_empty_dists_gives_nan_surface():
    ...
    out = Results.axis_dict(1, dists, _dice(), _stats())
