...
from cardioseg.evaluation.overlay import Overlay
...
def test_pick_hero_raises_without_hcm():
    ...
    with pytest.raises(ValueError, match="arg is an empty sequence|empty"):
        Overlay.pick_hero_cases([_c("a", "NOR", 60, 58)])
