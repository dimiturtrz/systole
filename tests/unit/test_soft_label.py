...
from cardioseg.training.augment import soften
...
def test_soften_shape_and_normalized():
    ...
    s = soften(m, sigma=1.0, n_classes=4)
...
def test_soften_sigma0_is_crisp_onehot():
    ...
    s = soften(m, sigma=0.0, n_classes=4)
...
def test_softdicece_runs_on_soft_target():
    ...
    loss = SoftDiceCE()(logits, soften(y, sigma=1.0, n_classes=4))
