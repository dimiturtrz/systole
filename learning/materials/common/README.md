...
- [geometry-and-volumetry.md](geometry-and-volumetry.md) — B3 + the geometry thread: voxel→volume, Simpson's method, meshing, wall thickness, papillary convention.
- [segmentation-theory.md](segmentation-theory.md) — C2: U-Net, nnU-Net, 2D vs 3D, loss, augmentation, patient-level splits.
- [evaluation-theory.md](evaluation-theory.md) — Dice/Jaccard, Hausdorff/HD95, ASSD, volume & EF agreement (Bland-Altman), calibration, failure analysis.
